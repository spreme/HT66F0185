...
/***********TM0************/
	  	...
	  	_t0ae=1;	    		//开t0中断
/***********时基0************/	  
	  	_tbc=0b00110111;       //时基定时器配置使能 fTBC时钟源 LXT快速启振
	  	//_tb0f=0;               //时基0中断请求标志清零
	  	//_tb0e=0;               //时基0中断控制位使能
...
//======================端口初始化==============================//	   
     ...
     GPIOB_INIT(GPIO_Pin_2,GPIO_Mode_INT,SET);
     GPIOB_INIT(GPIO_Pin_3,GPIO_Mode_INT,SET);
     GPIOB_INIT(GPIO_Pin_4,GPIO_Mode_INT,SET);
     buz=0;
//======================END====================================//
	   while(1)
		 {
