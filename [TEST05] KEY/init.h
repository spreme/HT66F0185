...
//==============按键控制引脚定义===================//
#define 	key1   			    _pb4     //数据0 数据1
#define 	key1mode   	  	_pbc4    //0输出 1输入
#define 	key1modepu   	  _pbpu4   //输入/输出引脚上拉控制 0：除能  1：使能

#define 	key2   			    _pb3
#define 	key2mode   		  _pbc3
#define 	key2modepu   		_pbpu3

#define 	key3    			  _pb2
#define 	key3mode     		_pbc2
#define 	key3modepu     	_pbpu2
//==============继电器蜂鸣器引脚定义===================//
#define   buz             _pa7
