...
#define 	keydown   			_pa2     //数据0 数据1
#define 	keydownmode   	_pac2    //0输出 1输入
#define 	keydownmodepu   _papu2   //输入/输出引脚上拉控制 0：除能  1：使能

#define 	keyset   			  _pa6
#define 	keysetmode   		_pac6
#define 	keysetmodepu   	_papu6
